...
export function buildRetailInitPrompt(input: {
  ...
  return [
    ...
    "CREATE THESE FILES:",
    "",
    "PRE-SEEDED before the agent loop (plumbing only — do NOT project_create_file; use write/edit to build UI): theme-toggle, route-loading-bar, not-found, cart-drawer stub, shadcn ui/*, providers, store hooks, data, app.css, and commerce route THIN SHELLS (src/routes/index.tsx, src/routes/products/*, cart, checkout, orders/*) wired to hooks with minimal placeholders. Layout and sections are NOT pre-built — you own storefront layout via the design taste skill. Create src/routes/__root.tsx, src/components/layout/site-header.tsx, src/components/layout/site-footer.tsx, and store sections under src/components/store/ as needed. Do not remove commerce routes.",
    "",
    ...
    "",
    "src/components/layout/site-footer.tsx - CREATE (not pre-seeded). Footer with Shop/Support/Company/Connect columns; colors from DESIGN.md deep/deep-foreground tokens. __root.tsx should import <SiteFooter />.",
    "",
