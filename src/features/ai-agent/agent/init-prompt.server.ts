...
export function buildRetailInitPrompt(input: {
  ...
  return [
    ...
    "",
    "src/components/layout/site-footer.tsx - Use `bg-deep text-deep-foreground` (mapped from DESIGN.md primary+primary-foreground), 4 cols (Shop/Support/Company/Connect), responsive grid",
    "",
