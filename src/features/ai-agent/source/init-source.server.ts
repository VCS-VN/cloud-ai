...
function appCssSource() {
  return `@tailwind base;\n@tailwind components;\n@tailwind utilities;\n\n@layer base {\n  :root {\n    --background: 40 33% 96%; --foreground: 0 0% 9%; --card: 0 0% 100%; --card-foreground: 0 0% 9%; --popover: 0 0% 100%; --popover-foreground: 0 0% 9%; --primary: 155 100% 23%; --primary-foreground: 0 0% 100%; --secondary: 40 33% 93%; --secondary-foreground: 0 0% 9%; --muted: 40 33% 93%; --muted-foreground: 0 0% 40%; --accent: 40 33% 93%; --accent-foreground: 0 0% 9%; --destructive: 4 72% 44%; --destructive-foreground: 0 0% 100%; --border: 0 0% 90%; --input: 0 0% 90%; --ring: 155 100% 23%; --radius: 0.75rem;\n  }\n  * { @apply border-border; }\n  body { @apply bg-background text-foreground; margin: 0; font-family: Inter, Manrope, system-ui, -apple-system, sans-serif; }\n}\n`;
}
