import { readProjectFile } from "@/features/ai-agent/code-tools/services/project-file-reader.server";
import {
  findForbiddenCustomerCopySnippets,
  hasCatalogUiSignal,
  scanStorefrontCustomerCopy,
} from "@/features/ai-agent/code-tools/services/storefront-customer-copy-guard.server";
