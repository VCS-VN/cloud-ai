...
} from "@/features/ai-agent/planning/extract-website-spec.server";
...
` },
    ...
    {
      path: "src/components/store/not-found.tsx",
      content: notFoundSource(),
    },
    ...renderInitCommerceSeedFiles(spec),
  ];
}

/** Providers, store hooks, catalog components, and commerce routes — seeded before the agent loop. */
export function renderInitCommerceSeedFiles(spec: WebsiteSpec): GeneratedFile[] {
  return [
...
function routeTreeSource() {
  return `/* eslint-disable */
// @ts-nocheck
// This file is generated by the Builder init seed. TanStack Router may regenerate it.
import { Route as rootRoute } from './routes/__root'
import { Route as IndexRouteImport } from './routes/index'
import { Route as ProductsRouteImport } from './routes/products/route'
import { Route as ProductsIndexRouteImport } from './routes/products/index'
import { Route as ProductDetailRouteImport } from './routes/products/$productId'
import { Route as CartRouteImport } from './routes/cart'
import { Route as CheckoutRouteImport } from './routes/checkout'
import { Route as OrdersIndexRouteImport } from './routes/orders/index'
import { Route as OrderDetailRouteImport } from './routes/orders/$orderId'
