  ...
  return (
    ...
    >
      <header className="mb-md flex flex-col gap-sm xl:flex-row xl:items-start xl:justify-between">
            ...
            <button
              className="builder-button bg-[var(--color-primary)] text-[var(--color-on-primary)] [&_svg]:text-[var(--app-icon-selected)]"
              type="button"
              onClick={goDashboard}
            >
          ...
          <div className="mb-md flex flex-col gap-xs xl:flex-row xl:items-center">
            <label className="relative min-w-0 flex-1" htmlFor="project-search">
              ...
              <Search
                className="pointer-events-none absolute left-sm top-1/2 -translate-y-1/2 text-[var(--app-icon-subtle)]"
                aria-hidden="true"
                size={16}
              />
              <input
