...
import { updateProfile } from "@/server/functions/auth";
      ...
      <div className="mx-auto grid max-w-3xl gap-4">
        <header className="flex items-center justify-between gap-4">
          <div>
            ...
            <h1 className="m-0 mt-1 text-h2 font-semibold tracking-tight">
              Manage profile
            </h1>
          </div>
          <UserMenu user={user} />
          ...
          <div className="px-6 pb-5">
            <div className="-mt-11 flex items-end gap-4">
              ...
              <div className="min-w-0 pb-1.5">
                ...
                <p className="m-0 mt-0.5 truncate text-ui-sm text-muted">
                  {user.email}
                </p>
              </div>
            </div>
        ...
        >
          ...
          <div className="flex items-center justify-between gap-3 border-t border-hairline bg-chalk/40 px-6 py-3.5">
            <span aria-live="polite" className="text-ui-sm">
              {status === "saved" ? (
                <span className="text-success-fg">Profile saved.</span>
              ) : null}
              {status === "error" ? (
