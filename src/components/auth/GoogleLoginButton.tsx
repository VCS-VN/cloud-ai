...
export function GoogleLoginButton({ loading = false, disabled = false, onClick }: GoogleLoginButtonProps) {
  return (
    <button
      className="inline-flex h-10 items-center justify-center gap-xs rounded-pill border border-[var(--app-border-strong)] bg-[var(--app-text)] px-md text-[14px] font-[650] text-[var(--app-bg)] shadow-panel outline-none transition-all duration-200 ease-out hover:translate-y-[-1px] hover:shadow-editorial focus-visible:ring-2 focus-visible:ring-[var(--app-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--app-panel)] disabled:translate-y-0 disabled:cursor-not-allowed disabled:opacity-60 disabled:shadow-none"
      type="button"
